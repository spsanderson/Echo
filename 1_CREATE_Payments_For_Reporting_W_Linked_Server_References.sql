...
DROP TABLE IF EXISTS [Payments_For_Reporting]
GO

	CREATE TABLE [Payments_For_Reporting] (
...
INSERT INTO [Payments_For_Reporting] (
	[PA-PT-NO-WOSCD],
	[PA-PT-NO-SCD],
...
INNER JOIN [dbo].[Encounters_For_Reporting] b ON a.[pa-pt-no-woscd] = b.[pa-pt-no-woscd] 
	AND a.[pa-ctl-paa-xfer-date] = b.[pa-ctl-paa-xfer-date] AND a.[pa-dtl-unit-date]=b.[pa-unit-date]
LEFT JOIN [ECHOLOADERDBP.UHMC.SBUH.STONYBROOK.EDU].[Echo_Archive].dbo.[PatientDemographics] C ON A.[PA-PT-NO-WOSCD] = C.[PA-PT-NO-WOSCD] and a.[pa-ctl-paa-xfer-date]=c.[pa-ctl-paa-xfer-date]
	


WHERE (a.[pa-dtl-type-ind] ='1' OR a.[pa-dtl-svc-cd-woscd] IN ('60320','60215'))
...
LEFT JOIN [ECHOLOADERDBP.UHMC.SBUH.STONYBROOK.EDU].[Echo_Active].dbo.[PatientDemographics] C ON A.[PA-PT-NO-WOSCD] = C.[PA-PT-NO-WOSCD] and a.[pa-ctl-paa-xfer-date]=c.[pa-ctl-paa-xfer-date]
...
FROM [ECHOLOADERDBP.UHMC.SBUH.STONYBROOK.EDU].[Echo_ACTIVE].dbo.[DetailInformation] a
INNER JOIN dbo.[Encounters_For_Reporting] b ON a.[pa-pt-no-woscd] = b.[pa-pt-no-woscd]
	AND b.[pa-unit-date] IS NULL and a.[pa-ctl-paa-xfer-date]=b.[pa-ctl-paa-xfer-date]
LEFT JOIN [ECHOLOADERDBP.UHMC.SBUH.STONYBROOK.EDU].[Echo_ACTIVE].dbo.[PatientDemographics] C ON A.[PA-PT-NO-WOSCD] = C.[PA-PT-NO-WOSCD] and a.[pa-ctl-paa-xfer-date]=c.[pa-ctl-paa-xfer-date]

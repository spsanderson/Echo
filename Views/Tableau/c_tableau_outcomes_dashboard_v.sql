/*
***********************************************************************
File: c_tableau_outcomes_dashboard_v.sql
...
Creates Table/View:
	c_tableau_outcomes_dashboard_v
...
2023-06-26	v2			Add more JOC codes per Chris
2023-09-29	v3			Add the following to correct dollars in reort
...
2023-10-27	v4			Add join for pa-ctl-paa-xfer-date and unit_date
***********************************************************************
*/
-- Create a new view called 'c_tableau_outcomes_dashboard_v' in schema 'dbo'
...
IF EXISTS (
		...
		WHERE sys.schemas.name = N'dbo'
			AND sys.VIEWS.name = N'c_tableau_outcomes_dashboard_v'
		)
	DROP VIEW dbo.c_tableau_outcomes_dashboard_v
GO

-- Create the view in the specified schema
CREATE VIEW dbo.c_tableau_outcomes_dashboard_v
AS
-- body of the view
WITH CTE
AS (

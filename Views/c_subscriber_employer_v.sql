/*
***********************************************************************
File: c_subscriber_employer_v.sql
...
Purpose/Description
	Crate a view for the subscriber/employer information
...
-- Create a new view called 'c_subscriber_employer_v' in schema 'dbo'
...
IF EXISTS (
		...
		WHERE sys.schemas.name = N'dbo'
			AND sys.VIEWS.name = N'c_subscriber_employer_v'
		)
	DROP VIEW dbo.c_subscriber_employer_v
GO

-- Create the view in the specified schema
CREATE VIEW dbo.c_subscriber_employer_v
AS

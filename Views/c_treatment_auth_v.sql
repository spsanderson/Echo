...
----		----		----
2023-04-03	v1			Initial Creation
2023-04-10	v2		    Move to Echo_SBU_FinPARA database
***********************************************************************
*/

-- Create a new view called 'c_treatment_auth' in schema 'dbo'
...
SELECT *
    ...
    AND sys.views.name = N'c_treatment_auth'
)
DROP VIEW dbo.c_treatment_auth
GO
-- Create the view in the specified schema
CREATE VIEW dbo.c_treatment_auth
AS
...
FROM OPENQUERY([ECHOLOADERDBP.UHMC.SBUH.STONYBROOK.EDU], '
SELECT [PA-REGION-CD]
      ,[PA-HOSP-CD]
      ,[PA-PT-NO-WOSCD]
	  ,[PA-PT-NO-SCD-1]
	  ...
	  ,[COMPONENT-DESCRIPTION] = ''TREATMENT AUTHORIZATION''
	  ,[PA-USER-TEXT]
	  , CASE
  ...
  WHERE [PA-COMPONENT-ID] = ''5C49AUTH''

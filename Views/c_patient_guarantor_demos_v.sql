/*
***********************************************************************
File: c_patient_guarantor_demos_v.sql
...
Purpose/Description
	Crate a view for the guarantor demographics

Revision History:
Date		Version		Description
----		----		----
2023-04-11	v1			Initial Creation
***********************************************************************
*/

-- Create a new view called 'c_patient_guarantor_demos_v' in schema 'dbo'
...
IF EXISTS (
		...
		WHERE sys.schemas.name = N'dbo'
			AND sys.VIEWS.name = N'c_patient_guarantor_demos_v'
		)
	DROP VIEW dbo.c_patient_guarantor_demos_v
GO

-- Create the view in the specified schema
CREATE VIEW dbo.c_patient_guarantor_demos_v
AS
    SELECT [pa-pt-no-woscd],
        [pa-pt-no-scd-1],
        CAST([PA-PT-NO-WOSCD] AS VARCHAR) + CAST([PA-PT-NO-SCD-1] AS VARCHAR) AS [pt_no],
        [pa-ctl-paa-xfer-date],
        [PA-NAD-LAST-OR-ORGZ-NAME] AS [guarantor_last_name],
        [PA-NAD-FIRST-OR-ORGZ-CNTC] AS [guarantor_first_name],

/*
***********************************************************************
File: c_patient_gurantor_employer_v.sql
...
Purpose/Description
	Crate a view for the patient gurantor employer data
...
-- Create a new view called 'c_patient_gurantor_employer_v' in schema 'dbo'
...
IF EXISTS (
		...
		WHERE sys.schemas.name = N'dbo'
			AND sys.VIEWS.name = N'c_patient_gurantor_employer_v'
		)
	DROP VIEW dbo.c_patient_gurantor_employer_v
GO

-- Create the view in the specified schema
CREATE VIEW dbo.c_patient_gurantor_employer_v
AS

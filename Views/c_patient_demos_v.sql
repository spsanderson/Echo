...
Purpose/Description
	Crate a view for the patient demographics
...
-- Create a new view called 'c_patient_demos_v' in schema 'dbo'
...
IF EXISTS (
		...
		WHERE sys.schemas.name = N'dbo'
			AND sys.VIEWS.name = N'c_patient_demos_v'
		)
	DROP VIEW dbo.c_patient_demos_v
GO

-- Create the view in the specified schema
CREATE VIEW dbo.c_patient_demos_v
AS

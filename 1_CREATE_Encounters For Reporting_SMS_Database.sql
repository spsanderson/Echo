...
INSERT INTO Encounters_For_Reporting ([PA-PT-NO-WOSCD],[PA-PT-NO-SCD],[PA-CTL-PAA-XFER-DATE],[pa-unit-no],[pa-med-rec-no],[pa-pt-name],[admit_date],[dsch_date],[pa-unit-date],[start_unit_date],[end_unit_date],[pa-acct-type],[1st_bl_date],[balance],
...
ON a.[pa-pt-no-woscd]= m.[pa-pt-no-woscd] and b.[pa-unit-no]=m.[pa-unit-no] 
...
left outer join [Echo_Archive].dbo.PatientDemographics l

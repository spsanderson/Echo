...
/*
***********************************************************************
File: sms_ptacct_v_encounters_for_reporting_unit_sp.sql
...
Creates Table:
	dbo.encounters_for_reporting_unit
...
Purpose/Description
	Run in batch 1
	Create patient account view dbo.encounters_for_reporting_unit
...
CREATE PROCEDURE dbo.c_sms_ptacct_v_encounters_for_reporting_unit_sp
AS
SET ANSI_NULLS ON
...
BEGIN
	...
	INSERT INTO dbo.encounters_for_reporting_unit (
		[PA-PT-NO-WOSCD],
		[PA-PT-NO-SCD],
		[PT_NO],
		[PA-UNIT-STS],

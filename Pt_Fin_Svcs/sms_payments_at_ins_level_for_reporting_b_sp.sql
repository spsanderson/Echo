...
/*
***********************************************************************
File: sms_payments_at_ins_level_forr_reporting_b_sp.sql
...
CREATE PROCEDURE dbo.c_sms_payments_at_ins_level_for_reporting_b_sp
AS
...
BEGIN
	...
	IF OBJECT_ID('dbo.Payments_For_Reporting_Ins_Plan_Level_ALT_B', 'U') IS NOT NULL
		TRUNCATE TABLE dbo.Payments_For_Reporting_Ins_Plan_Level_ALT_B
	ELSE
		CREATE TABLE dbo.[Payments_For_Reporting_Ins_Plan_Level_ALT_B] (
	...
	-- QUERY
	INSERT INTO dbo.Payments_For_Reporting_Ins_Plan_Level_ALT_B

...
----		----		----
2020-11-16	v1			Initial Creation
***********************************************************************
*/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE dbo.c_sms_payments_at_ins_level_for_reporting_a_sp
AS
...
BEGIN
	...
	IF OBJECT_ID('dbo.Payments_For_Reporting_Ins_Plan_Level_ALT_A', 'U') IS NOT NULL
		TRUNCATE TABLE dbo.Payments_For_Reporting_Ins_Plan_Level_ALT_A
	ELSE
		CREATE TABLE dbo.[Payments_For_Reporting_Ins_Plan_Level_ALT_A] (
	...
	-- QUERY
	INSERT INTO dbo.Payments_For_Reporting_Ins_Plan_Level_ALT_A

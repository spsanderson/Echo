...
DROP TABLE IF EXISTS [Charges_For_Reporting]

GO

CREATE TABLE [Charges_For_Reporting]
...
INSERT INTO [Charges_For_Reporting] ([PA-PT-NO-WOSCD],[PA-PT-NO-SCD],[PA-UNIT-NO],[unit-date],[PA-DTL-UNIT-DATE],[TYPE],[PA-DTL-TYPE-IND],[PA-DTL-GL-NO],[PA-DTL-REV-CD],[PA-DTL-CPT-CD],[PA-DTL-SVC-CD],[PA-DTL-CDM-DESCRIPTION],[TOT-CHG-QTY],[TOT-CHARGES],[TOT-PROF-FEES])
...
FROM [Echo_Archive].dbo.[DetailInformation] a inner join [SMS].[UHMC\smathesi].[Encounters_For_Reporting] b
...
FROM [Echo_ACTIVE].dbo.[DetailInformation] a inner join [Encounters_For_Reporting] b
ON a.[pa-pt-no-woscd]=b.[pa-pt-no-woscd] AND A.[PA-DTL-DATE] >= B.[START_UNIT_DATE] AND A.[PA-DTL-DATE] <= B.[END_UNIT_DATE] and a.[pa-ctl-paa-xfer-date]=b.[pa-ctl-paa-xfer-date]--AND b.[pa-unit-date] = a.[pa-dtl-unit-date]--DATEADD(DAY,-(DAY(DATEADD(MONTH, 1,a.[pa-dtl-date]))),DATEADD(MONTH,1,a.[pa-dtl-date]))
...
GROUP BY a.[pa-pt-no-woscd], a.[pa-pt-no-scd-1],B.[PA-UNIT-NO],b.[pa-unit-date],A.[PA-DTL-UNIT-DATE],B.[PTACCT_TYPE],A.[PA-DTL-TYPE-IND],A.[PA-DTL-GL-NO],A.[PA-DTL-CPT-CD],A.[PA-DTL-REV-CD],A.[PA-DTL-SVC-CD-WOSCD],A.[PA-DTL-SVC-CD-SCD],A.[PA-DTL-CDM-DESCRIPTION]
...
FROM [Echo_Archive].dbo.[DetailInformation] a inner join [Encounters_For_Reporting] b

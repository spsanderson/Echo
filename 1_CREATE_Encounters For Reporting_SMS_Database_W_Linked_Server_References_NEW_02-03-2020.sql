...
INSERT INTO [#Units] ([PA-PT-NO-WOSCD],[PA-PT-NO-SCD],[UNIT-DATE],[pa-unit-no],[PA-CTL-PAA-XFER-DATE],[PA-UNIT-STS])
...
WHERE  ( a.[pa-acct-type] in ('0','6','7') AND b.[pa-unit-no] is not null and b.[pa-unit-date] BETWEEN '2007-01-01 00:00:00.000' AND getdate())
...
INSERT INTO [#Units_W_Rank] ([PA-PT-NO-WOSCD],[PA-PT-NO-SCD],[PA-CTL-PAA-XFER-DATE],[UNIT-DATE],[pa-unit-no],[alt-pa-unit-no],[PA-UNIT-STS])
...
INSERT INTO Encounters_For_Reporting ([PA-PT-NO-WOSCD],[PA-PT-NO-SCD],[PT_NO],[PA-UNIT-STS],[FILE_TYPE],[PA-CTL-PAA-XFER-DATE],[pa-unit-no],[pa-med-rec-no],[pa-pt-name],[admit_date],[dsch_date],[pa-unit-date],[start_unit_date],[end_unit_date],[pa-acct-type],[1st_bl_date],[balance],
[pt_balance],[tot_chgs],[pa-bal-tot-pt-pay-amt],[ptacct_type],[pa-fc],[fc_description],[pa-hosp-svc],[pa-acct-sub-type],[pa-pt-representative],[pa-pay-scale])--,[pa-nad-first-or-orgz-cntc],[pa-nad-last-or-orgz-name])
...
,a.[pa-unit-sts]
,CASE
WHEN a.[pa-acct-type] in ('0','7') THEN 'OP' --0=OP; 6=OP BAD DEBT; 7=OP HISTORIC
WHEN a.[pa-acct-type] IN ('6') THEN 'OB'
WHEN a.[pa-acct-type] IN ('4') THEN 'IB'
WHEN a.[pa-acct-type] in ('1') THEN 'IP'
WHEN a.[pa-acct-type] IN ('2','8') THEN 'AR'
ELSE ''
END AS 'File_Type'
...
FROM [ECHOLOADERDBP.UHMC.SBUH.STONYBROOK.EDU].[Echo_Archive].dbo.PatientDemographics a left outer join [ECHOLOADERDBP.UHMC.SBUH.STONYBROOK.EDU].[Echo_Archive].dbo.[UnitizedAccounts] b
ON a.[pa-pt-no-woscd] = b.[pa-pt-no-woscd] and a.[pa-unit-sts] = 'U' AND a.[pa-ctl-paa-xfer-date] = b.[pa-ctl-paa-xfer-date]
left outer join [Unit_Partitions] m
ON b.[pa-pt-no-woscd]=m.[pa-pt-no-woscd] and b.[pa-unit-date] >= m.[start_unit_date] and b.[pa-unit-date] <= m.[end_unit_date]

...
WITH [PAIDDATES_CTE] ([pa-pt-no-woscd],[pa-pt-no-scd],[pa-dtl-type-ind],[pa-dtl-ins-co-cd],[pa-dtl-ins-plan-no],[pa-dtl-svc-cd-woscd],[pa-dtl-svc-cd-scd],[pa-dtl-chg-amt],[pa-dtl-date],[pa-last-fc-cng-date],[pa-fc],[pa-last-fc],[pa-pt-type])
...
AND b.[pa-unit-sts]='2'--'0' has units; '2' no units
)
...
WITH [PAIDDATES2_CTE] ([pa-pt-no-woscd],[pa-pt-no-scd],[pa-dtl-type-ind],[pa-dtl-ins-co-cd],[pa-dtl-ins-plan-no],[pa-dtl-svc-cd-woscd],[pa-dtl-svc-cd-scd],[pa-dtl-chg-amt],[pa-dtl-date],[pa-last-fc-cng-date],[pa-fc],[pa-last-fc],[pa-pt-type])

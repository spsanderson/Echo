...
,(c.[pa-bal-ins-pay-amt] + c.[pa-bal-ins-pror-chg-amt] + c.[pa-bal-ins-adj-amt]) as 'Ins1_Bal'
,(d.[pa-bal-ins-pay-amt] + d.[pa-bal-ins-pror-chg-amt] + d.[pa-bal-ins-adj-amt]) as 'Ins2_Bal'
,(e.[pa-bal-ins-pay-amt] + e.[pa-bal-ins-pror-chg-amt] + e.[pa-bal-ins-adj-amt]) as 'Ins3_Bal'
,(f.[pa-bal-ins-pay-amt] + f.[pa-bal-ins-pror-chg-amt] + f.[pa-bal-ins-adj-amt]) as 'Ins4_Bal'
...
(((c.[pa-ins-co-cd]='D' and (c.[pa-bal-ins-pay-amt] + c.[pa-bal-ins-pror-chg-amt] + c.[pa-bal-ins-adj-amt]) < '0')
OR
(d.[pa-ins-co-cd]='D' and (d.[pa-bal-ins-pay-amt] + d.[pa-bal-ins-pror-chg-amt] + d.[pa-bal-ins-adj-amt]) < '0')
OR
(e.[pa-ins-co-cd]='D' and (e.[pa-bal-ins-pay-amt] + e.[pa-bal-ins-pror-chg-amt] + e.[pa-bal-ins-adj-amt]) < '0')
OR
(f.[pa-ins-co-cd]='D' and (f.[pa-bal-ins-pay-amt] + f.[pa-bal-ins-pror-chg-amt] + f.[pa-bal-ins-adj-amt]) < '0'))
AND b.[pa-unit-no] IS NULL
AND a.[pa-pt-no-woscd] NOT IN

(SELECT DISTINCT([pa-pt-no-woscd])
FROM dbo.DetailInformation
WHERE [pa-dtl-svc-cd-woscd]='10808'
AND [pa-dtl-post-date] = '2017-05-31 00:00:00.000'
)
)

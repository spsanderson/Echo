...
AND (
	(
		...
		OR 
		[pa-nad-first-or-orgz-cntc] LIKE '%JAIL %'
	)
	OR 
	(
		[pa-nad-last-or-orgz-name] LIKE '%JAIL'
...
, RANK() OVER (
	...
	ORDER BY b.[pa-bal-ins-pay-amt] asc
	, b.[pa-ins-prty] asc
	, b.[pa-ins-co-cd] asc
...
FROM [Distinct_Encounters_For_DSH] AS A 
INNER JOIN [Echo_Archive].DBO.INSURANCEINFORMATION AS B
ON A.[PA-PT-NO-WOSCD] = B.[PA-PT-NO-WOSCD] 
--AND A.[PA-CTL-PAA-XFER-DATE]=B.[PA-CTL-PAA-XFER-DATE]
LEFT OUTER JOIN [IM_PATIENTS] AS C
...
FROM [Distinct_Encounters_For_DSH] AS A 
INNER JOIN [Echo_Active].DBO.INSURANCEINFORMATION AS B
ON A.[PA-PT-NO-WOSCD] = B.[PA-PT-NO-WOSCD] 
--AND A.[PA-CTL-PAA-XFER-DATE]=B.[PA-CTL-PAA-XFER-DATE]
LEFT OUTER JOIN [SMS].[UHMC\smathesi].[IM_PATIENTS] AS C
ON A.[PA-PT-NO-WOSCD] = C.[PA-PT-NO-WOSCD]
...
INSERT INTO [Secondary_Ins_Indicators_Summary] ([PA-PT-NO-WOSCD],[PA-PT-NO-SCD],[2NDRY-MEDICAID-FFS],[2NDRY-MEDICAID-ELIGIBLE],[2NDRY-MEDICAID-PENDING-IND],[2NDRY-MEDICAID-OUT-OF-STATE-IND],

[2NDRY-OTHER-INS-IND],[2NDRY-MEDICARE-IND],[2NDRY-SELF-PAY-IND],[TOT-INS-PAYMTS])--,[REPORT-GROUP])
...
GROUP BY B.[pa-pt-no-woscd], B.[pa-pt-no-scd]
...
CASE WHEN a.[pa-acct-type] IN ('0', '6', '7') THEN 'OP' WHEN a.[pa-acct-type] IN ('1', '2', '4', '8') THEN 'IP' ELSE '' END AS [PtAcct-Type],
...
WHEN i.[indicator] = 'PRIMARY MEDICAID' AND j.[2NDRY-MEDICAID-ELIGIBLE]='0' AND J.[2NDRY-MEDICAID-OUT-OF-STATE-IND]='0' AND J.[2NDRY-MEDICAID-PENDING-IND]='0' AND J.[2NDRY-MEDICARE-IND]='0'

AND J.[2NDRY-OTHER-INS-IND]='0' THEN 'PRIMARY MEDICAID'

WHEN i.[indicator] = 'PRIMARY MEDICAID' AND (J.[2NDRY-MEDICAID-ELIGIBLE]>'0' OR J.[2NDRY-MEDICARE-IND]>'0' OR J.[2NDRY-OTHER-INS-IND]>'0') AND J.[2NDRY-MEDICAID-OUT-OF-STATE-IND]='0' AND J.[2NDRY-MEDICAID-PENDING-IND]='0' THEN 'MEDICAID FFS DUAL ELIGIBLE'

--WHEN I.[INDICATOR] = 'PRIMARY MEDICAID' AND J.[2NDRY-MEDICARE-IND]>'0' THEN 'DUAL ELIGIBLE'

WHEN I.[INDICATOR] = 'PRIMARY MANAGED MEDICAID' and j.[2NDRY-MEDICAID-ELIGIBLE]='0' AND J.[2NDRY-MEDICAID-OUT-OF-STATE-IND]='0'  AND J.[2NDRY-MEDICAID-PENDING-IND]='0' AND J.[2NDRY-MEDICARE-IND]='0'

AND J.[2NDRY-OTHER-INS-IND]='0' AND J.[2NDRY-MEDICAID-OUT-OF-STATE-IND] = '0' THEN 'PRIMARY MEDICAID MANAGED CARE'

WHEN I.[INDICATOR] = 'PRIMARY MANAGED MEDICAID' and (j.[2NDRY-MEDICAID-ELIGIBLE]>'0' OR J.[2NDRY-MEDICAID-OUT-OF-STATE-IND]>'0' OR J.[2NDRY-MEDICAID-PENDING-IND]>'0' OR J.[2NDRY-MEDICARE-IND]>'0'

OR J.[2NDRY-OTHER-INS-IND]>'0'OR J.[2NDRY-MEDICARE-IND]>'0') THEN 'MEDICAID MANAGED CARE DUAL ELIGIBLE'

--WHEN I.[INDICATOR] = 'PRIMARY MANAGED MEDICAID' AND J.[2NDRY-MEDICARE-IND]>'0' THEN 'DUAL ELIGIBLE'

WHEN I.[INDICATOR] = 'PRIMARY SELF PAY' THEN 'PRIMARY SELF PAY'

WHEN I.[INDICATOR] = 'PRIMARY OUT OF STATE MEDICAID' and j.[2NDRY-MEDICAID-ELIGIBLE]='0' AND J.[2NDRY-MEDICAID-OUT-OF-STATE-IND]='0' AND J.[2NDRY-MEDICAID-PENDING-IND]='0' AND J.[2NDRY-MEDICARE-IND]='0'

AND J.[2NDRY-OTHER-INS-IND]='0'THEN 'PRIMARY OUT OF STATE MEDICAID'

WHEN I.[INDICATOR] = 'PRIMARY OUT OF STATE MEDICAID' and (j.[2NDRY-MEDICAID-ELIGIBLE]>'0' OR J.[2NDRY-MEDICAID-OUT-OF-STATE-IND]>'0' OR J.[2NDRY-MEDICAID-PENDING-IND]>'0' AND J.[2NDRY-MEDICARE-IND]>'0'

OR J.[2NDRY-OTHER-INS-IND]>'0')THEN 'DUAL ELIGIBLE OUT OF STATE MEDICAID'

WHEN I.[INDICATOR] in ('OTHER PRIMARY PAYER','PRIMARY MEDICARE') AND (j.[2ndry-medicaid-ffs]> '0' and J.[2NDRY-MEDICAID-ELIGIBLE]='0' AND J.[2NDRY-MEDICAID-OUT-OF-STATE-IND]='0') THEN 'MEDICAID FFS DUAL ELIGIBLE'

WHEN I.[INDICATOR] in ('OTHER PRIMARY PAYER','PRIMARY MEDICARE') AND (J.[2NDRY-MEDICAID-FFS]> '0' AND J.[2NDRY-MEDICAID-ELIGIBLE]>'0' AND J.[2NDRY-MEDICAID-OUT-OF-STATE-IND]='0') THEN 'MEDICAID MANAGED CARE DUAL ELIGIBLE'

WHEN I.[INDICATOR] in ('OTHER PRIMARY PAYER','PRIMARY MEDICARE') AND (J.[2NDRY-MEDICAID-FFS]='0' AND J.[2NDRY-MEDICAID-ELIGIBLE]='0' AND J.[2NDRY-MEDICAID-OUT-OF-STATE-IND]>'0') THEN 'DUAL ELIGIBLE OUT OF STATE MEDICAID'

WHEN I.[INDICATOR] IS NULL THEN 'PRIMARY SELF PAY'
...
WHEN i.[indicator] = 'PRIMARY MEDICAID' AND (J.[2NDRY-MEDICAID-ELIGIBLE]>'0' OR J.[2NDRY-MEDICARE-IND]>'0' OR J.[2NDRY-OTHER-INS-IND]>'0') AND J.[2NDRY-MEDICAID-OUT-OF-STATE-IND]>'0' AND J.[2NDRY-MEDICAID-PENDING-IND]='0' AND J.[2NDRY-MEDICARE-IND]='0' THEN 'MEDICAID FFS DUAL ELIGIBLE'
...
FROM [Encounters_For_DSH] a left outer join [CUSTOMINSURANCE] b

ON a.[pa-pt-no-woscd]=b.[pa-pt-no-woscd] and b.[rank1]='1'

left outer join [CUSTOMINSURANCE] c

ON a.[pa-pt-no-woscd]=c.[pa-pt-no-woscd] and c.[rank1] = '2'

left outer join [CUSTOMINSURANCE] d

ON a.[pa-pt-no-woscd]=d.[pa-pt-no-woscd] and d.[rank1]='3'

left outer join [CUSTOMINSURANCE] e

ON a.[pa-pt-no-woscd]=e.[pa-pt-no-woscd] and e.[rank1]='4'

left outer join [CUSTOMINSURANCE] f

ON a.[pa-pt-no-woscd]=f.[pa-pt-no-woscd] and f.[rank1]='5'

left outer join [CUSTOMINSURANCE] g

ON a.[pa-pt-no-woscd]=g.[pa-pt-no-woscd] and g.[rank1]='6'

left outer join [CUSTOMINSURANCE] h

ON a.[pa-pt-no-woscd]=h.[pa-pt-no-woscd] and h.[rank1]='7'

left outer join [Primary_Ins_Type] i

ON a.[pa-pt-no-woscd]=i.[pa-pt-no-woscd] and i.[rank1]='1'

left outer join [Secondary_Ins_Indicators_Summary] j

ON a.[pa-pt-no-woscd]=j.[pa-pt-no-woscd]

left outer join [IM_Patients] k

ON a.[pa-pt-no-woscd]=k.[pa-pt-no-woscd]

...
FROM [Encounters_For_DSH] AS a 
left outer join [CUSTOMINSURANCE] AS b
ON a.[pa-pt-no-woscd] = b.[pa-pt-no-woscd] 
	and b.[rank1] = '1'
left outer join [CUSTOMINSURANCE] AS c
ON a.[pa-pt-no-woscd] = c.[pa-pt-no-woscd] 
	and c.[rank1] = '2'
left outer join [CUSTOMINSURANCE] AS d
ON a.[pa-pt-no-woscd] = d.[pa-pt-no-woscd] 
	and d.[rank1] = '3'
left outer join [CUSTOMINSURANCE] AS e
ON a.[pa-pt-no-woscd] = e.[pa-pt-no-woscd] 
	and e.[rank1] = '4'
left outer join [CUSTOMINSURANCE] AS f
ON a.[pa-pt-no-woscd] = f.[pa-pt-no-woscd] 
	and f.[rank1] = '5'
left outer join [CUSTOMINSURANCE] AS g
ON a.[pa-pt-no-woscd] = g.[pa-pt-no-woscd] 
	and g.[rank1] = '6'
left outer join [CUSTOMINSURANCE] AS h
ON a.[pa-pt-no-woscd] = h.[pa-pt-no-woscd] 
	and h.[rank1] = '7'
left outer join [Primary_Ins_Type] AS i
ON a.[pa-pt-no-woscd] = i.[pa-pt-no-woscd] 
	and i.[rank1] = '1'
left outer join [Secondary_Ins_Indicators_Summary] AS j
ON a.[pa-pt-no-woscd] = j.[pa-pt-no-woscd]
left outer join [IM_Patients] AS k

...
DROP TABLE IF EXISTS [DSH_Charges]
 
GO
 
CREATE TABLE [DSH_Charges]
...
INSERT INTO [DSH_Charges] ([PA-PT-NO-WOSCD],[PA-PT-NO-SCD],[PA-UNIT-NO],[unit-date],[PA-DTL-UNIT-DATE],[TYPE],[PA-DTL-TYPE-IND],[PA-DTL-GL-NO],[PA-DTL-REV-CD],[PA-DTL-CPT-CD],[PA-DTL-SVC-CD],[PA-DTL-CDM-DESCRIPTION],[TOT-CHG-QTY],[TOT-CHARGES],[TOT-PROF-FEES])

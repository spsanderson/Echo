...
WHERE (
	...
	AND (
		...
		OR
		[2NDRY-MEDICAID-ELIGIBLE] != '0'
		OR
		[2NDRY-MEDICAID-PENDING-IND] != '0'
		OR
		[2NDRY-MEDICAID-OUT-OF-STATE-IND] != '0'
	)
)
;
-----
...
, a.[PA-PT-NO-SCD]
, SUM(A.[TOT-INS-PAYMTS]) AS [TOT-MEDICARE-PRIM-MEDICAID-SECONDARY]
, SUM(B.[TOTAL-PAYMENTS]) AS [TOT-MEDICAID-SECONDARY-PAYMENTS]

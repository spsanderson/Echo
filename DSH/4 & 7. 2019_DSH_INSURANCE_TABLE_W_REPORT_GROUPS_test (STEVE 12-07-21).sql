...
*/
DROP TABLE IF EXISTS dbo.IM_Patients_TEST

CREATE TABLE dbo.[IM_Patients_TEST] (
...
INSERT INTO dbo.IM_Patients_TEST (
	[PA-PT-NO-WOSCD],
	[PA-PT-NO-SCD],
	[IM-IND],
	[PA-ACCT-TYPE]
...
*/
DROP TABLE IF EXISTS dbo.[DISTINCT_ENCOUNTERS_FOR_DSH_TEST]
	
CREATE TABLE dbo.[DISTINCT_ENCOUNTERS_FOR_DSH_TEST] (
	[PA-PT-NO-WOSCD] DECIMAL(11, 0) NOT NULL,
	[PA-PT-NO-SCD] CHAR(1) NOT NULL,
	[PA-CTL-PAA-XFER-DATE] DATETIME NULL
	);

INSERT INTO dbo.[DISTINCT_ENCOUNTERS_FOR_DSH_TEST] (
	[PA-PT-NO-WOSCD],
	[PA-PT-NO-SCD],
...
*/
DROP TABLE IF EXISTS #TEMP_CUSTOM_INS_TEST
SELECT A.*
INTO #TEMP_CUSTOM_INS_TEST
FROM (
	...
	FROM dbo.[Distinct_Encounters_For_DSH_TEST] A
	...
	LEFT OUTER JOIN dbo.[IM_PATIENTS_TEST] C ON A.[PA-PT-NO-WOSCD] = C.[PA-PT-NO-WOSCD]
...
DROP TABLE IF EXISTS dbo.CUSTOMINSURANCE_TEST
GO

CREATE TABLE dbo.CUSTOMINSURANCE_TEST (
	[PA-PT-NO-WOSCD] DECIMAL(11, 0) NOT NULL,
	[PA-PT-NO-SCD] CHAR(1) NOT NULL,
	[PA-CTL-PAA-XFER-DATE] DATETIME NULL,
...
INSERT INTO dbo.[CUSTOMINSURANCE_TEST] (
	[PA-PT-NO-WOSCD],
	[PA-PT-NO-SCD],
	[PA-CTL-PAA-XFER-DATE],
	[PA-INS-PRTY],
...
[IM-IND]
FROM #TEMP_CUSTOM_INS_TEST AS A
...
*/
DROP TABLE IF EXISTS dbo.[Primary_Ins_Type_TEST]

CREATE TABLE dbo.[Primary_Ins_Type_TEST] (
	[PA-PT-NO-WOSCD] DECIMAL(11, 0) NOT NULL,
	[PA-PT-NO-SCD] CHAR(1) NOT NULL,
	[PA-CTL-PAA-XFER-DATE] DATETIME NULL,
	[RANK1] CHAR(4),
...
INSERT INTO dbo.[Primary_Ins_Type_TEST] (
	[PA-PT-NO-WOSCD],
	[PA-PT-NO-SCD],
	[PA-CTL-PAA-XFER-DATE],
	[RANK1],
...
*/
DROP TABLE IF EXISTS dbo.[Secondary_Ins_Indicators_Detail_TEST]
GO
-- Add new table
CREATE TABLE dbo.[Secondary_Ins_Indicators_Detail_TEST] (
	[PA-PT-NO-WOSCD] DECIMAL(11, 0) NOT NULL,
	[PA-PT-NO-SCD] CHAR(1) NOT NULL,
	[PA-CTL-PAA-XFER-DATE] DATETIME NULL,
...
INSERT INTO dbo.[Secondary_Ins_Indicators_Detail_TEST] (
	[PA-PT-NO-WOSCD],
	[PA-PT-NO-SCD],
	[PA-CTL-PAA-XFER-DATE],
	[PA-INS-PLAN],
...
*/
DROP TABLE IF EXISTS dbo.[Secondary_Ins_Indicators_Summary_TEST] 
GO
--Add New Table
CREATE TABLE dbo.[Secondary_Ins_Indicators_Summary_TEST] (
	[PA-PT-NO-WOSCD] DECIMAL(11, 0) NOT NULL,
	[PA-PT-NO-SCD] CHAR(1) NOT NULL,
	[PA-CTL-PAA-XFER-DATE] DATETIME NULL,
	[2NDRY-MEDICAID-FFS] DECIMAL(1, 0) NOT NULL,
...
INSERT INTO dbo.[Secondary_Ins_Indicators_Summary_TEST] (
	[PA-PT-NO-WOSCD],
	[PA-PT-NO-SCD],
	[PA-CTL-PAA-XFER-DATE],
	[2NDRY-MEDICAID-FFS],
...
FROM dbo.[Secondary_Ins_Indicators_Detail_TEST] B
...
*/
DROP TABLE IF EXISTS [dbo].[DSH_DENIALS_ENCOUNTERS_W_SELECTED_DENIALS_TEST]
--GO
CREATE TABLE [dbo].[DSH_DENIALS_ENCOUNTERS_W_SELECTED_DENIALS_TEST] (
...
INSERT INTO [dbo].[DSH_DENIALS_ENCOUNTERS_W_SELECTED_DENIALS_TEST] (
    [PA-PT-NO-WOSCD],
    [PA-PT-NO-SCD],
    [PT-NO],
    [PA-UNIT-NO],
...
*/
DROP TABLE IF EXISTS [dbo].[DSH_MEDICAID_PMT_INDICATOR_TEST] 
GO

CREATE TABLE [dbo].[DSH_MEDICAID_PMT_INDICATOR_TEST] (
	[PA-PT-NO-WOSCD] VARCHAR(50) NOT NULL,
	[PA-PT-NO-SCD] CHAR(1) NOT NULL,
	[PT-NO] VARCHAR(51) NOT NULL,
	[PA-UNIT-NO] VARCHAR(50) NULL,
...
INSERT INTO [dbo].[DSH_MEDICAID_PMT_INDICATOR_TEST] (
    [PA-PT-NO-WOSCD],
    [PA-PT-NO-SCD],
    [PT-NO],
    [PA-UNIT-NO],
...
*/
DROP TABLE IF EXISTS dbo.[DSH_INSURANCE_TABLE_W_REPORT_GROUPS_TEST] 
GO
--Add New Table
SELECT a.[PA-PT-NO-WOSCD],
	a.[PA-PT-NO-SCD],
	...
	J.[TOT-INS-PAYMTS],
	k.[im-ind]
INTO #DSH_INSURANCE_TABLE_W_REPORT_GROUPS_TEMP_TEST
FROM dbo.[Encounters_For_DSH] a
LEFT OUTER JOIN dbo.[CUSTOMINSURANCE_TEST] b ON a.[pa-pt-no-woscd] = b.[pa-pt-no-woscd]
	AND a.[PA-CTL-PAA-XFER-DATE] = b.[PA-CTL-PAA-XFER-DATE]
	AND b.[rank1] = '1'
LEFT OUTER JOIN dbo.[CUSTOMINSURANCE_TEST] c ON a.[pa-pt-no-woscd] = c.[pa-pt-no-woscd]
	AND a.[PA-CTL-PAA-XFER-DATE] = c.[PA-CTL-PAA-XFER-DATE]
	AND c.[rank1] = '2'
LEFT OUTER JOIN dbo.[CUSTOMINSURANCE_TEST] d ON a.[pa-pt-no-woscd] = d.[pa-pt-no-woscd]
	AND a.[PA-CTL-PAA-XFER-DATE] = d.[PA-CTL-PAA-XFER-DATE]
	AND d.[rank1] = '3'
LEFT OUTER JOIN dbo.[CUSTOMINSURANCE_TEST] e ON a.[pa-pt-no-woscd] = e.[pa-pt-no-woscd]
	AND a.[PA-CTL-PAA-XFER-DATE] = e.[PA-CTL-PAA-XFER-DATE]
	AND e.[rank1] = '4'
LEFT OUTER JOIN dbo.[CUSTOMINSURANCE_TEST] f ON a.[pa-pt-no-woscd] = f.[pa-pt-no-woscd]
	AND a.[PA-CTL-PAA-XFER-DATE] = f.[PA-CTL-PAA-XFER-DATE]
	AND f.[rank1] = '5'
LEFT OUTER JOIN dbo.[CUSTOMINSURANCE_TEST] g ON a.[pa-pt-no-woscd] = g.[pa-pt-no-woscd]
	AND a.[PA-CTL-PAA-XFER-DATE] = g.[PA-CTL-PAA-XFER-DATE]
	AND g.[rank1] = '6'
LEFT OUTER JOIN dbo.[CUSTOMINSURANCE_TEST] h ON a.[pa-pt-no-woscd] = h.[pa-pt-no-woscd]
	AND a.[PA-CTL-PAA-XFER-DATE] = h.[PA-CTL-PAA-XFER-DATE]
	AND h.[rank1] = '7'
LEFT OUTER JOIN dbo.[Primary_Ins_Type_TEST] i ON a.[pa-pt-no-woscd] = i.[pa-pt-no-woscd]
	AND a.[PA-CTL-PAA-XFER-DATE] = i.[PA-CTL-PAA-XFER-DATE]
	AND i.[rank1] = '1'
LEFT OUTER JOIN dbo.[Secondary_Ins_Indicators_Summary_TEST] j ON a.[pa-pt-no-woscd] = j.[pa-pt-no-woscd]
	AND a.[PA-CTL-PAA-XFER-DATE] = j.[PA-CTL-PAA-XFER-DATE]
LEFT OUTER JOIN dbo.[IM_Patients_TEST] k ON a.[pa-pt-no-woscd] = k.[pa-pt-no-woscd]
LEFT OUTER JOIN [DBO].[DSH_MEDICAID_PMT_INDICATOR_TEST] AS MPI ON A.[PA-PT-NO-WOSCD] = MPI.[PA-PT-NO-WOSCD]
	AND A.[PA-PT-NO-SCD] = MPI.[PA-PT-NO-SCD]
	AND A.[pa-unit-no] IS NULL
LEFT OUTER JOIN [DBO].[DSH_MEDICAID_PMT_INDICATOR_TEST] AS MPI2 ON A.[PA-PT-NO-WOSCD] = MPI2.[PA-PT-NO-WOSCD]
	AND A.[PA-PT-NO-SCD] = MPI2.[PA-PT-NO-SCD]
	AND MPI2.[PA-UNIT-NO] IS NOT NULL
	AND A.[pa-unit-no] = MPI2.[PA-UNIT-NO]
LEFT OUTER JOIN [DBO].[DSH_DENIALS_ENCOUNTERS_W_SELECTED_DENIALS_TEST] AS DI1 ON A.[PA-PT-NO-WOSCD] = DI1.[PA-PT-NO-WOSCD]
	AND A.[PA-PT-NO-SCD] = DI1.[PA-PT-NO-SCD]
	AND A.[pa-unit-no] IS NULL
LEFT OUTER JOIN [DBO].[DSH_DENIALS_ENCOUNTERS_W_SELECTED_DENIALS_TEST] AS DI2 ON A.[PA-PT-NO-WOSCD] = DI2.[PA-PT-NO-WOSCD]
...
SELECT [PA-PT-NO-WOSCD],
	...
	[TOT-INS-PAYMTS],
	[im-ind]
INTO dbo.[DSH_INSURANCE_TABLE_W_REPORT_GROUPS_TEST]
FROM #DSH_INSURANCE_TABLE_W_REPORT_GROUPS_TEMP_TEST AS A
GROUP BY [PA-PT-NO-WOSCD],
	[PA-PT-NO-SCD],
	[PA-CTL-PAA-XFER-DATE],
	[pa-unit-no],
...
DROP TABLE IF EXISTS #DSH_INSURANCE_TABLE_W_REPORT_GROUPS_TEMP_TEST
DROP TABLE IF EXISTS [dbo].[DSH_DENIALS_ENCOUNTERS_W_SELECTED_DENIALS_TEST]
GO
;
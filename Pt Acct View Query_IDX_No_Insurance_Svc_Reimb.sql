...
AND a.[pa-hosp-svc] IN ('ABC','CTP','CVC','DIB','DRM','EYE','GNO','ICD','IPD','KMR','KOB','KOP','KUR','NBS','NSY','OBE','OTH','OTP','OUR','PEM','PGM','PTP','PTR','RRC','SDO','SGY',
'TGS','TUR')
...
--AND COALESCE(b.[pa-unit-tot-chg-amt],a.[pa-bal-tot-chg-amt]) <> '0'
--AND COALESCE(b.[pa-unit-op-first-ins-bl-date],a.[pa-final-bill-date],a.[pa-op-first-ins-bl-date]) IS NULL

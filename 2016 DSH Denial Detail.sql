...
DROP TABLE IF EXISTS [2016_DSH_Denials_Detail]
...
INSERT INTO [2016_DSH_Denials_Detail] ([PA-PT-NO-WOSCD],[PA-PT-NO-SCD],[PT-NO] ,[PA-UNIT-NO],[unit-date],[PA-DTL-UNIT-DATE],[TYPE],[PA-DTL-TYPE-IND],[PA-DTL-GL-NO],[PA-DTL-REV-CD],[PA-DTL-CPT-CD],
[PA-DTL-SVC-CD],[PA-DTL-CDM-DESCRIPTION],[PA-UNIT-STS],[TOT-BFW-ACCOUNT],[TOT-BFW-CHG],[TOT-CHG-QTY],[TOT-CHARGES],[TOT-PROF-FEES])
...
FROM [Echo_Archive].dbo.[DetailInformation] a inner join [Encounters_For_DSH] b
ON a.[pa-pt-no-woscd]=b.[pa-pt-no-woscd] AND A.[PA-DTL-unit-DATE] =  B.[pa-unit-date] and a.[pa-ctl-paa-xfer-date]=b.[pa-ctl-paa-xfer-date]--AND b.[pa-unit-date] = a.[pa-dtl-unit-date]--DATEADD(DAY,-(DAY(DATEADD(MONTH, 1,a.[pa-dtl-date]))),DATEADD(MONTH,1,a.[pa-dtl-date]))
...
GROUP BY a.[pa-pt-no-woscd], a.[pa-pt-no-scd-1],B.[PA-UNIT-NO],b.[pa-unit-date],A.[PA-DTL-UNIT-DATE],B.[PTACCT_TYPE],A.[PA-DTL-TYPE-IND],A.[PA-DTL-GL-NO],A.[PA-DTL-REV-CD],A.[PA-DTL-CPT-CD],A.[PA-DTL-SVC-CD-WOSCD],A.[PA-DTL-SVC-CD-SCD],A.[PA-DTL-CDM-DESCRIPTION],c.[PA-UNIT-STS],c.[pa-bfw-acct-tot],c.[PA-BFW-CHG-TOT]
...
FROM [Echo_ACTIVE].dbo.[DetailInformation] a inner join [Encounters_For_DSH] b
ON a.[pa-pt-no-woscd]=b.[pa-pt-no-woscd] AND A.[PA-DTL-unit-DATE] =  B.[pa-unit-date] and a.[pa-ctl-paa-xfer-date]=b.[pa-ctl-paa-xfer-date]--AND b.[pa-unit-date] = a.[pa-dtl-unit-date]--DATEADD(DAY,-(DAY(DATEADD(MONTH, 1,a.[pa-dtl-date]))),DATEADD(MONTH,1,a.[pa-dtl-date]))
...
FROM [Echo_Archive].dbo.[DetailInformation] a inner join [Encounters_For_DSH] b
ON a.[pa-pt-no-woscd]=b.[pa-pt-no-woscd] AND b.[pa-unit-no] is null AND a.[pa-ctl-paa-xfer-date]=b.[pa-ctl-paa-xfer-date]--DATEADD(DAY,-(DAY(DATEADD(MONTH, 1,a.[pa-dtl-date]))),DATEADD(MONTH,1,a.[pa-dtl-date]))
left join [Echo_Archive].dbo.[PatientDemographics] C ON A.[PA-PT-NO-WOSCD]=C.[PA-PT-NO-WOSCD]
...
FROM [Echo_ACTIVE].dbo.[DetailInformation] a inner join [Encounters_For_DSH] b
ON a.[pa-pt-no-woscd]=b.[pa-pt-no-woscd] AND b.[pa-unit-no] is null --DATEADD(DAY,-(DAY(DATEADD(MONTH, 1,a.[pa-dtl-date]))),DATEADD(MONTH,1,a.[pa-dtl-date]))
left join [Echo_ACTIVE].dbo.[PatientDemographics] C ON A.[PA-PT-NO-WOSCD]=C.[PA-PT-NO-WOSCD]

...
ON a.[pa-pt-no-woscd]=c.[pa-pt-no-woscd] and c.[pa-ins-prty]='1'  and a.[pa-acct-type] <> '7'
left outer join [Echo_Active].dbo.insuranceinformation d
ON a.[pa-pt-no-woscd]=d.[pa-pt-no-woscd] and d.[pa-ins-prty]='2'  and a.[pa-acct-type] <> '7'
left outer join [Echo_Active].dbo.insuranceinformation e
ON a.[pa-pt-no-woscd]=e.[pa-pt-no-woscd] and e.[pa-ins-prty]='3'  and a.[pa-acct-type] <> '7'
left outer join [Echo_Active].dbo.insuranceinformation f
ON a.[pa-pt-no-woscd]=f.[pa-pt-no-woscd] and f.[pa-ins-prty]='4'  and a.[pa-acct-type] <> '7'
...
--COALESCE(b.[pa-unit-tot-chg-amt],a.[pa-bal-tot-chg-amt]) <> '0'
...
a.[pa-acct-type] IN ('4','6','7','8')
AND a.[pa-fc] IN ('3','5')
AND((b.[pa-unit-no] is null and a.[pa-acct-bd-xfr-date] BETWEEN '2016-01-01 00:00:00.000' AND '2016-12-31 23:59:59.000')
OR (b.[pa-unit-no] is not null and b.[pa-unit-xfr-bd-date] BETWEEN '2016-07-01 00:00:00.000' AND '2016-12-31 23:59:59.000'))

--a.[pa-acct-type] IN ('0','1','2')
...
a.[pa-acct-type] IN ('4','6','7','8')
AND a.[pa-fc] IN ('3','5')
AND((b.[pa-unit-no] is null and a.[pa-acct-bd-xfr-date] BETWEEN '2016-07-01 00:00:00.000' AND '2016-12-31 23:59:59.000')
OR (b.[pa-unit-no] is not null and b.[pa-unit-xfr-bd-date] BETWEEN '2016-07-01 00:00:00.000' AND '2016-12-31 23:59:59.000'))

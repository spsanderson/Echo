...
DROP TABLE IF EXISTS [Payments_For_Reporting_Ins_Plan_Level]
GO

	CREATE TABLE [Payments_For_Reporting_Ins_Plan_Level] (
...
INSERT INTO [Payments_For_Reporting_Ins_Plan_Level] (
	[PA-PT-NO-WOSCD],
	[PA-PT-NO-SCD],

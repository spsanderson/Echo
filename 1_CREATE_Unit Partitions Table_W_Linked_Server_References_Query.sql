...
INSERT INTO [#Units] ([PA-PT-NO-WOSCD],[PA-PT-NO-SCD],[PA-PT-NAME],[PA-MED-REC-NO],[UNIT-DATE],[pa-unit-no],[pa-hosp-svc])
...
WHERE  ( a.[pa-acct-type] in ('0','6','7') AND b.[pa-unit-no] is not null and b.[pa-unit-date] BETWEEN '2006-11-01 00:00:00.000' AND GETDATE())
...
INSERT INTO [#Units_W_Rank] ([PA-PT-NO-WOSCD],[PA-PT-NO-SCD],[PA-PT-NAME],[PA-MED-REC-NO],[UNIT-DATE],[pa-unit-no],[alt-pa-unit-no],[pa-hosp-svc])

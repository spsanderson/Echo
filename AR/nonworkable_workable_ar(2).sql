...
DEPARTMENT = CASE
	...
	AND A.INS_BUCKETS = 'PRIMARY'
    AND A.payer_organization NOT IN (
'EMPLOYEE HEALTH',
'INSTITUTIONAL',
'MEDICAID FFS',
'MEDICARE FFS',

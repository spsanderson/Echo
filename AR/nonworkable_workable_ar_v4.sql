...
SELECT DISTINCT A.PT_NO,
    ...
    [WORKLISTED] = CASE 
        WHEN COALESCE(A.[WORKLIST NAME ON INS1], A.[WORKLIST NAME ON INS2], A.[WORKLIST NAME ON INS3], A.[WORKLIST NAME ON INS4], A.[Worklist Name on Pt]) IS NULL
            THEN 'NO'
        ELSE 'YES'
        END,
    A.FC,
	...
	[BUCKET_INS_CODE_LAST_EXPORTED_DATE] = CASE
		...
		DEPARTMENT = COALESCE(WDT.DEPARTMENT, PRD.DEPARTMENT),
		A.[RESPONSIBLE COLLECTOR],
		[SUPERVISOR] = WDT.SUPV_ID
INTO #INDICATOR_TBL
...
SELECT PT_NO,
	...
	DSCH_DATE,
	BALANCE,
	[GT_5K] = CASE WHEN BALANCE >= 5000 THEN 1 ELSE 0 END,
	[ACCTS>120_DAYS] = CASE WHEN Age_Bucket IN ('5_121-150','6_151-180','7_181-210','8_211-240','9_241-365','90_1yr-1.5yrs','91_1.5-2yrs','92_2+yrs') THEN 1 ELSE 0 END,
	PT_BALANCE,
	INS1_BALANCE,
	INS2_BALANCE,
	INS3_BALANCE,

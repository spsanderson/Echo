/*
***********************************************************************
File: nonworkable_workable_ar_v12.sql
...
SELECT PT_NO,
	...
	INITIAL_DEPARTMENT = CASE
		...
		-- TEST, PT_REP 156 IS ELENA, SHE IS NOW IN VM
		-- THIS SHOULD BE ABLE TO JUST BE REMOVED
		--WHEN PT_REPRESENTATIVE IN ('156')
		--	AND [FILE] NOT IN ('INHOUSE', 'DNFB')
		--	THEN 'ANALYST TEAM'
		-- END TEST
...
SELECT A.PT_NO,
	...
	[WORKABLE_INDICATOR] = CASE
		...
		END,
		EXPECTED_PAYMENT,
		CYCLE_OF_WL = ISNULL(WL_CYCLES.[Cycle of WL],''),
		[CYCLE_OF_WL_20+] = CASE WHEN WL_CYCLES.[Cycle of WL] >= '20' THEN 1 ELSE 0 END
INTO #FINAL
...
[GT_$5K] = SUM(GT_5K),
[%AR$>120] = 
CASE WHEN SUM(BALANCE) = 0 THEN 0 ELSE SUM([DOLLARS>120_DAYS]) * 1.0 / SUM(BALANCE) END,
[AVG_WL_CYCLES] = AVG(CYCLE_OF_WL),
[WL_CYCLE_20+] = SUM([CYCLE_OF_WL_20+]),

...
WITH [PAIDDATES_CTE] ([pa-pt-no-woscd],[pa-pt-no-scd],[pa-dtl-type-ind],[pa-dtl-ins-co-cd],[pa-dtl-ins-plan-no],[pa-dtl-svc-cd-woscd],[pa-dtl-svc-cd-scd],[pa-dtl-chg-amt],[pa-dtl-date],[pa-acct-bd-xfr-date],[pa-fc],[pa-last-fc],[pa-pt-type],[Rank])
...
AND b.[pa-acct-bd-xfr-date] > '12/31/2014'
AND b.[pa-unit-sts]='N'--'0' has units; '2' no units
--AND a.[pa-dtl-svc-cd-woscd] <> '10202'
)
,
[PAIDDATES2_CTE] ([pa-pt-no-woscd],[pa-pt-no-scd],[pa-dtl-type-ind],[pa-dtl-ins-co-cd],[pa-dtl-ins-plan-no],[pa-dtl-svc-cd-woscd],[pa-dtl-svc-cd-scd],[pa-dtl-chg-amt],[pa-dtl-date],[pa-acct-bd-xfr-date],[pa-fc],[pa-last-fc],[pa-pt-type],[Rank])

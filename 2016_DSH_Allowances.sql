...
DROP TABLE IF EXISTS [2016_DSH_Allowances]
GO

	CREATE TABLE [2016_DSH_Allowances] (
		...
		[TOT-ALLOWANCES] MONEY NULL,
		);

INSERT INTO [2016_DSH_Allowances] (
	[PA-PT-NO-WOSCD],
	[PA-PT-NO-SCD],
	[PT-NO],
	[PA-UNIT-NO],
...
SELECT a.[pa-pt-no-woscd],
	...
	SUM(A.[PA-DTL-CHG-AMT]) AS 'TOT-ALLOWANCES'
...
WHERE a.[pa-dtl-type-ind] IN ('3','4')

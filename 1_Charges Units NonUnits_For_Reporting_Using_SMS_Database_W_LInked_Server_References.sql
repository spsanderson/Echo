...
INSERT INTO [SMS].dbo.[Charges_For_Reporting] ([PA-PT-NO-WOSCD],[PA-PT-NO-SCD],[PA-UNIT-NO],[unit-date],[PA-DTL-UNIT-DATE],[TYPE],[PA-DTL-TYPE-IND],[PA-DTL-GL-NO],[PA-DTL-REV-CD],[PA-DTL-CPT-CD],[PA-DTL-PROC-CD-MODF(1)],[PA-DTL-PROC-CD-MODF(2)],[PA-DTL-PROC-CD-MODF(3)],[PA-DTL-SVC-CD],[PA-DTL-CDM-DESCRIPTION],[TOT-CHG-QTY],[TOT-CHARGES],[TOT-PROF-FEES])
...
FROM [ECHOLOADERDBP.UHMC.SBUH.STONYBROOK.EDU].[Echo_ACTIVE].dbo.[DetailInformation] a inner join dbo.[Encounters_For_Reporting] b
ON a.[pa-pt-no-woscd]=b.[pa-pt-no-woscd] AND A.[PA-DTL-DATE] >= B.[START_UNIT_DATE] AND A.[PA-DTL-DATE] <= B.[END_UNIT_DATE] and a.[pa-ctl-paa-xfer-date]=b.[pa-ctl-paa-xfer-date]--AND b.[pa-unit-date] = a.[pa-dtl-unit-date]--DATEADD(DAY,-(DAY(DATEADD(MONTH, 1,a.[pa-dtl-date]))),DATEADD(MONTH,1,a.[pa-dtl-date]))
...
GROUP BY a.[pa-pt-no-woscd], a.[pa-pt-no-scd-1],B.[PA-UNIT-NO],b.[pa-unit-date],A.[PA-DTL-UNIT-DATE],B.[PTACCT_TYPE],A.[PA-DTL-TYPE-IND],A.[PA-DTL-GL-NO],A.[PA-DTL-CPT-CD],A.[PA-DTL-PROC-CD-MODF(1)],
A.[PA-DTL-PROC-CD-MODF(2)],A.[PA-DTL-PROC-CD-MODF(3)],A.[PA-DTL-REV-CD],A.[PA-DTL-SVC-CD-WOSCD],A.[PA-DTL-SVC-CD-SCD],A.[PA-DTL-CDM-DESCRIPTION]

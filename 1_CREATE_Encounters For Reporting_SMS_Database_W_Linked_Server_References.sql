...
INSERT INTO [#Units] ([PA-PT-NO-WOSCD],[PA-PT-NO-SCD],[UNIT-DATE],[pa-unit-no])
...
WHERE  ( a.[pa-acct-type] in ('0','6','7') AND b.[pa-unit-no] is not null and b.[pa-unit-date] BETWEEN '2007-01-01 00:00:00.000' AND '2019-11-30 23:59:59.000')
...
INSERT INTO [#Units_W_Rank] ([PA-PT-NO-WOSCD],[PA-PT-NO-SCD],[UNIT-DATE],[pa-unit-no],[alt-pa-unit-no])
...
INSERT INTO Encounters_For_Reporting ([PA-PT-NO-WOSCD],[PA-PT-NO-SCD],[PT_NO],[FILE_TYPE],[PA-CTL-PAA-XFER-DATE],[pa-unit-no],[pa-med-rec-no],[pa-pt-name],[admit_date],[dsch_date],[pa-unit-date],[start_unit_date],[end_unit_date],[pa-acct-type],[1st_bl_date],[balance],
[pt_balance],[tot_chgs],[pa-bal-tot-pt-pay-amt],[ptacct_type],[pa-fc],[fc_description],[pa-hosp-svc],[pa-acct-sub-type])--,[pa-nad-first-or-orgz-cntc],[pa-nad-last-or-orgz-name])
...
FROM [ECHOLOADERDBP.UHMC.SBUH.STONYBROOK.EDU].[Echo_Archive].dbo.PatientDemographics a left outer join [ECHOLOADERDBP.UHMC.SBUH.STONYBROOK.EDU].[Echo_Archive].dbo.[UnitizedAccounts] b
ON a.[pa-pt-no-woscd] = b.[pa-pt-no-woscd] and a.[pa-unit-sts] = 'U' 

# =========================
# Billing Units KPI Report Formatter
# =========================
# This script transforms Finalized_Billing_KPI_Report_v1.xlsx
...
## --------------------------
input_file <- "W:/PATACCT/Billing KPI’s/Katie - KPIs/Billing units - KPI reports/Finalized_Billing_KPI_Report_v1.xlsx"
output_file <- "W:/PATACCT/Billing KPI’s/Katie - KPIs/Billing units - KPI reports/billing_units_kpi_report.xlsx"
...
metric_map <- c(
  "# of Claims Worked in Scrubber - Touched" = "NUMBER_OF_CLAIMS_WORKED_IN_SCRUBBER_TOUCHED",
  "# of Claims Worked in Scrubber - Released" = "NUMBER_OF_CLAIMS_WORKED_IN_SCRUBBER_RELEASED",
  "Unbilled Assigned Claims" = "UNBILLED_ASSIGNED_CLAIMS",
  "# of Days Worked" = "NUMBER_OF_DAYS_WORKED",
  "% of Completion - Proficiency" = "PERCENT_OF_COMPLETION_PROFICIENCY",
  "# of Accounts Worked on Worklists - Weekly" = "NUMBER_OF_ACCOUNTS_WORKED_ON_WORKLISTS_WEEKLY",
  "Combined Productivity - Weekly - Completed" = "COMBINED_PRODUCTIVITY_WEEKLY_COMPLETED",
  "Combined Productivity Goal for the Week" = "COMBINED_PRODUCTIVITY_GOAL_FOR_THE_WEEK",
  "Accounts on Worklist - Start of Week" = "ACCOUNTS_ON_WORKLIST_START_OF_WEEK",
  "Accounts on Worklist - End of Week" = "ACCOUNTS_ON_WORKLIST_END_OF_WEEK",
  "# of Errors (Monthly Audit)" = "NUMBER_OF_ERRORS_MONTHLY_AUDIT"
)

# =========================================================
# RI RCM KPI Report Formatter
# =========================================================
# This script transforms Finalized_RI_RCM_KPI_Report_v1.xlsx
...
## --------------------------
input_file <- "W:/PATACCT/Billing KPI’s/Katie - KPIs/RI-RCM KPI reports/Finalized_RI_RCM_KPI_Report_v1.xlsx"
output_file <- "W:/PATACCT/Billing KPI’s/Katie - KPIs/RI-RCM KPI reports/ri_rcm_kpi_report.xlsx"
...
metric_map <- c(
  "# of Claims Completed" = "NUMBER_OF_CLAIMS_COMPLETED",
  "Metrics" = "NUMBER_OF_CLAIMS_DELETED",
  "# of Claims Completed" = "NUMBER_OF_CLAIMS_HELD",
  "# of Claims Deleted" = "NUMBER_OF_CLAIMS_INCOMPLETE",
  "# of Claims Held" = "NUMBER_OF_CLAIMS_OUTGOING",
  "# of Claims Incomplete" = "NUMBER_OF_CLAIMS_REASSIGNED",
  "# of Claims Outgoing" = "TOTAL_CLAIMS_TOUCHED",
  "# of Claims Reassigned" = "ACCOUNTS_WORKED_ON_INVISION_WORKLISTS",
  "Total Claims Touched" = "STARTING_INVENTORY",
  "Accounts Worked on Invision Worklists" = "ENDING_INVENTORY"
)

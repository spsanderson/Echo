# =========================================================
# Non Government Follow Up KPI Report Formatter
# =========================================================
# This script transforms Non_Govt_Follow_Up_KPI_Report.xlsx
...
## --------------------------
input_file <- "W:/PATACCT/BusinessOfc/FOLLOW UP UNITS/KPI/Master KPI/Non_Govt_Follow_Up_KPI_Report.xlsx"
output_file <- "W:/PATACCT/BusinessOfc/FOLLOW UP UNITS/KPI/Master KPI/non_gov_fol_up_kpi_report.xlsx"
...
metric_map <- c(
  ...
  "Metrics" = "WEEKLY_PRODUCTIVITY_TARGET",
  "# of Days Worked" = "NUMBER_OF_ACCOUNTS_WORKED_ON_WORLISTS_WEEKLY",
  "Weekly Productivity Target" = "DAILY_PRODUCTIVITY",
  "# of Accounts Worked on Worklists - Weekly" = "NUMBER_OF_ACCOUNTS_ON_WORKLIST_START_OF_WEEK",
  "Daily Productivity" = "NUMBER_OF_ACCOUNTS_ON_WORKLIST_END_OF_WEEK",
  "# of Accounts on Worklist - Start of Week" = "NUMBER_OF_NEW_ACCOUNTS_ON_WORKLIST",
  "# of Accounts on Worklist - End of Week" = "NUMBER_OF_OLD_ACCOUNTS_ON_WORKLIST"
)

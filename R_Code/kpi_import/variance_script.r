# =========================================================
# Variance KPI Report Formatter
# =========================================================
# This script transforms Finalized_Variance_KPI_Report_v1.xlsx
...
## --------------------------
input_file <- "W:/PATACCT/BusinessOfc/Revenue Cycle Analyst/Ray G/Variance KPI/Finalized_Variance_KPI_Report_v1.xlsx"
output_file <- "W:/PATACCT/BusinessOfc/Revenue Cycle Analyst/Ray G/Variance KPI/variance_kpi_report.xlsx"
...
metric_map <- c(
  ...
  "# of Accounts Worked on Worklists - Weekly" = "WEEKLY_PRODUCTIVITY_TARGET",

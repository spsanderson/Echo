# =========================================================
# Insurance Verification KPI Report Formatter
# =========================================================
# This script transforms Insurance_Verification_KPI_Report.xlsx
...
## --------------------------
input_file <- "W:/PATACCT/BusinessOfc/Insurance_Verification/KPI/Insurance_Verification_KPI_Report.xlsx"
output_file <- "W:/PATACCT/BusinessOfc/Insurance_Verification/KPI/ins_ver_kpi_report.xlsx"
...
wb <- createWorkbook()
sn <- "ins_verification_kpi_report"
addWorksheet(wb, sn)

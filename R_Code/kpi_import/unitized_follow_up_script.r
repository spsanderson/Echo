# =========================================================
# Unitized Follow Up KPI Report Formatter
# =========================================================
# This script transforms Unitized_Follow_Up_KPI_Report.xlsx
...
## --------------------------
input_file <- "W:/PATACCT/BusinessOfc/FOLLOW UP UNITS/KPI/Master KPI/Unitized_Follow_Up_KPI_Report.xlsx"
output_file <- "W:/PATACCT/BusinessOfc/FOLLOW UP UNITS/KPI/Master KPI/unit_accts_fol_up_kpi_report_.xlsx"
...
metric_map <- c(
  ...
  "# of Old Accounts on Worklist" = "NUMBER-OF_OLD_ACCOUNTS_ON_WORKLIST",
...
wb <- createWorkbook()
sn <- "unit_accts_fol_up_kpi_report"
addWorksheet(wb, sn)

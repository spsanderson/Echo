...
url <- "https://www.uhcprovider.com/en/policies-protocols/medicare-advantage-policies/medicare-advantage-reimbursement-policies.html"

# Read the HTML content from the page
page <- read_html(url)

# Use html_node() to select the first matching element with the provided XPath
node <- html_node(page, xpath = '//*[@id="responsivegrid_1251783288-facetedlisting-items"]')
node
...
f_path <- "W:/PATACCT/BusinessOfc/Revenue Cycle Analyst/Payer_Policies/UHCPDFs/Medicare_Advantage/Reimbursement_Policies/"

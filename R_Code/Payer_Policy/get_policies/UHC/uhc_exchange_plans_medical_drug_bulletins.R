...
node <- html_node(page, xpath = '//*[@id="accordionitem-par-facetedlisting_84058-items"]')
node
...
f_path <- "W:/PATACCT/BusinessOfc/Revenue Cycle Analyst/Payer_Policies/UHCPDFs/Exchange_Plans/Medical_and_Drug_Bulletins/"

...
node <- html_node(page, xpath = "/html/body/div[1]/div/div/div[4]/div/div[4]/div/div[2]/div/div")
link_tbl <- node |> 
  html_elements("h3") |>
  html_elements("a") |>
  html_attr("href") |>
...
f_path <- "W:/PATACCT/BusinessOfc/Revenue Cycle Analyst/Payer_Policies/UHCPDFs/Commercial_Plans/Clinical_Guidelines/"

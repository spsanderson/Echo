...
link_url <- "https://www.uhcprovider.com/en/policies-protocols/protocols.html"
...
f_path <- "W:/PATACCT/BusinessOfc/Revenue Cycle Analyst/Payer_Policies/UHCPDFs/Commercial_Plans/Protocols/"
